function [h,hg,htick]=terplot1(number)
...
for i=1:number
    ...
    htick(i,3)=text(1-l(i)*cos(pi/3)+0.05,l(i)*sin(pi/3)+0.025,num2str(l(i)));
    htick(i,2)=text(0.5-l(i)*cos(pi/3)-0.05,sin(pi/3)*(1-l(i)),num2str(l(i)));
end
